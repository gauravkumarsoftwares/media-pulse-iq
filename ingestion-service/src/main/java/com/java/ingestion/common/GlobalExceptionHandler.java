...
public class GlobalExceptionHandler {
    ...
    /** Bean-validation failures on @Valid-annotated DTOs → 422 Unprocessable Entity. */
    ...
    /** Domain / business-rule exceptions with an explicit HTTP status. */
    ...
    /** Catch-all → 500 Internal Server Error (no internal detail leaked). */
